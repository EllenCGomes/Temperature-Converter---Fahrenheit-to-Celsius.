...
EXERCISE DESCRIPTION: Write a Python program that takes a temperature in Fahrenheit and converts to Celsius.
...
DESCRIÇÃO: Faça um programa em Python que recebe uma temperatura em Fahrenheit e converte para Celsius.
